...
class RoleMiddleware:
    ...
    def __call__(self, request):
        ...
        if not request.user.is_authenticated:
            ...
            print("Debug: User authenticated. Redirecting to login page.")
            ...
            user_role = request.user.role.name if hasattr(request.user, 'role') and request.user.role is not None and hasattr(request.user.role, 'name') else None
